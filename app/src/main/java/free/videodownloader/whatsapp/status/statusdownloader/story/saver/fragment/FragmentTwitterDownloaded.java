...
import static free.videodownloader.whatsapp.status.statusdownloader.story.saver.utils.Util.RootDirectoryTwitterShow;

public class FragmentTwitterDownloaded extends Fragment implements FileListClickInterface {
    private FragmentHistoryBinding binding;
    private RvFileListAdapter rvFileListAdapter;
    private ArrayList<File> fileArrayList;
    private ActivityGallery activity;

    public static FragmentTwitterDownloaded newInstance(String param1) {
        FragmentTwitterDownloaded fragment = new FragmentTwitterDownloaded();
    ...
    private void getAllFiles() {
        ...
        if (files != null) {
            ...
            rvFileListAdapter = new RvFileListAdapter(activity, fileArrayList, FragmentTwitterDownloaded.this);
