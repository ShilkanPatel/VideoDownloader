...
public class SharePrefereces {
    ...
    private static SharePrefereces instance;

    public static String MYAdsJson = "MYAdsJson";
    ...
    public SharePrefereces(Context context) {
        ctx = context;
        sharedPreferences = context.getSharedPreferences(PREFERENCE, 0);
    }

    public static SharePrefereces getInstance(Context ctx) {
        if (instance == null) {
            instance = new SharePrefereces(ctx);
        }
        return instance;
    }
