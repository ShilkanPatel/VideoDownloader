...
public class FragmentLikeeDownloaded extends Fragment implements FileListClickInterface {
    private FragmentHistoryBinding binding;
    private RvFileListAdapter rvFileListAdapter;
    private ArrayList<File> fileArrayList;
    private ActivityGallery activity;
    public static FragmentLikeeDownloaded newInstance(String param1) {
        FragmentLikeeDownloaded fragment = new FragmentLikeeDownloaded();
    ...
    private void getAllFiles(){
        ...
        if (files!=null) {
            ...
            rvFileListAdapter = new RvFileListAdapter(activity, fileArrayList, FragmentLikeeDownloaded.this);
