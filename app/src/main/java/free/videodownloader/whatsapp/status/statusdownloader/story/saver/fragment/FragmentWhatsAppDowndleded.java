...
public class FragmentWhatsAppDowndleded extends Fragment implements FileListClickInterface {
    private FragmentHistoryBinding binding;
    private RvFileListAdapter rvFileListAdapter;
    private ArrayList<File> fileArrayList;
    private ActivityGallery activity;

    public static FragmentWhatsAppDowndleded newInstance(String param1) {
        FragmentWhatsAppDowndleded fragment = new FragmentWhatsAppDowndleded();
    ...
    private void getAllFiles(){
        ...
        if (files!=null) {
            ...
            rvFileListAdapter = new RvFileListAdapter(activity, fileArrayList, FragmentWhatsAppDowndleded.this);
