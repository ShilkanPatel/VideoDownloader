...
import static free.videodownloader.whatsapp.status.statusdownloader.story.saver.utils.Util.RootDirectoryTikTokShow;

public class FragmentTikTokDownloaded extends Fragment implements FileListClickInterface {
    private FragmentHistoryBinding binding;
    private RvFileListAdapter rvFileListAdapter;
    private ArrayList<File> fileArrayList;
    private ActivityGallery activity;
    public static FragmentTikTokDownloaded newInstance(String param1) {
        FragmentTikTokDownloaded fragment = new FragmentTikTokDownloaded();
    ...
    private void getAllFiles(){
        ...
        if (files!=null) {
            ...
            rvFileListAdapter = new RvFileListAdapter(activity, fileArrayList, FragmentTikTokDownloaded.this);
