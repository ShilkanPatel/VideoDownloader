...
import static free.videodownloader.whatsapp.status.statusdownloader.story.saver.utils.Util.ShareVideo;
import static free.videodownloader.whatsapp.status.statusdownloader.story.saver.utils.Util.shareImage;

public class PagerShowImagesAdapter extends PagerAdapter {
    private Context context;
    private ArrayList<File> imageList;
    private LayoutInflater inflater;
    ActivityFullView activityFullView;

    public PagerShowImagesAdapter(Context context, ArrayList<File> imageList, ActivityFullView activityFullView) {
        this.context = context;
        this.imageList = imageList;
        this.activityFullView = activityFullView;
    ...
    public Object instantiateItem(@NotNull ViewGroup view, int position) {
        ...
        im_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (b){
                    activityFullView.deleteFileAA(position);
                }
            }
        });
        ...
        im_share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (extension.equals(".mp4")){
                    ...
                    ShareVideo(context,"Share Video",imageList.get(position).getPath());
                }else {
