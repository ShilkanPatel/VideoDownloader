...
import static free.videodownloader.whatsapp.status.statusdownloader.story.saver.utils.Util.RootDirectoryShareChatShow;

public class FragmentSharechatDownloaded extends Fragment implements FileListClickInterface {
    private FragmentHistoryBinding binding;
    private RvFileListAdapter rvFileListAdapter;
    private ArrayList<File> fileArrayList;
    private ActivityGallery activity;
    public static FragmentSharechatDownloaded newInstance(String param1) {
        FragmentSharechatDownloaded fragment = new FragmentSharechatDownloaded();
    ...
    private void getAllFiles(){
        ...
        if (files!=null) {
            ...
            rvFileListAdapter = new RvFileListAdapter(activity, fileArrayList, FragmentSharechatDownloaded.this);
