...
import static free.videodownloader.whatsapp.status.statusdownloader.story.saver.utils.Util.RootDirectoryInstaShow;

public class FragmentInstaDownloaded extends Fragment implements FileListClickInterface {
    private FragmentHistoryBinding binding;
    private RvFileListAdapter rvFileListAdapter;
    private ArrayList<File> fileArrayList;
    private ActivityGallery activity;

    public static FragmentInstaDownloaded newInstance(String param1) {
        FragmentInstaDownloaded fragment = new FragmentInstaDownloaded();
    ...
    private void getAllFiles() {
        ...
        if (files != null) {
            ...
            rvFileListAdapter = new RvFileListAdapter(activity, fileArrayList, FragmentInstaDownloaded.this);
