...
import static free.videodownloader.whatsapp.status.statusdownloader.story.saver.utils.Util.RootDirectoryRoposoShow;

public class FragmentRoposoDownloaded extends Fragment implements FileListClickInterface {
    private FragmentHistoryBinding binding;
    private RvFileListAdapter rvFileListAdapter;
    private ArrayList<File> fileArrayList;
    private ActivityGallery activity;
    public static FragmentRoposoDownloaded newInstance(String param1) {
        FragmentRoposoDownloaded fragment = new FragmentRoposoDownloaded();
    ...
    private void getAllFiles(){
        ...
        if (files!=null) {
            ...
            rvFileListAdapter = new RvFileListAdapter(activity, fileArrayList, FragmentRoposoDownloaded.this);
