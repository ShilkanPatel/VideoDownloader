...
import free.videodownloader.whatsapp.status.statusdownloader.story.saver.databinding.ActivityLikeeBinding;
...
import static free.videodownloader.whatsapp.status.statusdownloader.story.saver.utils.Util.RootDirectoryLikeeShow;
import static free.videodownloader.whatsapp.status.statusdownloader.story.saver.utils.Util.createFileFolder;

public class ActivityLikee extends AppCompatActivity {
    ActivityLikeeBinding binding;
    ActivityLikee activity;
...
//        MyAds.showGoogleSmartBanner(this, findViewById(R.id.banner_container_smart));
    ...
    private void initViews() {
        ...
        if (!SharePrefereces.getInstance(activity).getBoolean(SharePrefereces.ISSHOWHOWTOLIKEE)) {
            SharePrefereces.getInstance(activity).putBoolean(SharePrefereces.ISSHOWHOWTOLIKEE,true);
            binding.layoutHowTo.LLHowToLayout.setVisibility(View.VISIBLE);
        }else {
        ...
        binding.LLOpenLikee.setOnClickListener(v -> {
            Util.OpenApp(activity,"video.like");
        });
    }
    ...
    class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String file_url) {
            ...
            Util.setToast(activity,getResources().getString(R.string.download_complete));
            try {
