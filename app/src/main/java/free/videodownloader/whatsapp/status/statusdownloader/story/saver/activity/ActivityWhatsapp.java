...
import free.videodownloader.whatsapp.status.statusdownloader.story.saver.databinding.ActivityWhatsappBinding;
import free.videodownloader.whatsapp.status.statusdownloader.story.saver.fragment.FragmentWhatsappImage;
import free.videodownloader.whatsapp.status.statusdownloader.story.saver.fragment.FragmentWhatsappVideo;
...
public class ActivityWhatsapp extends AppCompatActivity {
    ...
    private ActivityWhatsapp activity;
    ...
    private void initViews() {
        ...
        binding.LLOpenWhatsapp.setOnClickListener(v -> {
            Util.OpenApp(activity,"com.whatsapp");
        });
    }
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new FragmentWhatsappImage(), getResources().getString(R.string.images));
        adapter.addFragment(new FragmentWhatsappVideo(), getResources().getString(R.string.videos));
